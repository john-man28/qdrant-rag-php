...
$hybridEnabled = filter_var(env('CATALOG_SEARCH_HYBRID_ENABLED', false), FILTER_VALIDATE_BOOL);
$searchMode = env('CATALOG_SEARCH_MODE');
...
return [
    'reload' => [
        ...
        'stale_after_seconds' => (int) env('CATALOG_RELOAD_STALE_AFTER', 900),
    ...
    'search' => [
        'mode' => is_string($searchMode) && trim($searchMode) !== ''
            ? mb_strtolower(trim($searchMode))
            : ($hybridEnabled ? 'hybrid_rerank' : 'dense'),
